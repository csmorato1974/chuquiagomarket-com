  ...
  return (
    <Layout>
      ...
      <section className="py-10 md:py-14">
        <div className="container-market">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { icon: Camera, title: '1. Publica', text: 'Sube fotos, describe tu producto y elige zona de La Paz. Es gratis.' },
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h2 className="text-xl md:text-2xl font-bold text-foreground">
                Publicaciones recientes en La Paz
              </h2>
              <p className="text-muted-foreground text-sm mt-1">
                Anuncios locales verificados
              </p>
            </div>
        ...
        <div className="container-market">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            {[
              ...
              { icon: Flag, title: 'Reporta anuncios', text: 'Ayúdanos a mantener la comunidad segura reportando abusos.' },
            ].map(({ icon: Icon, title, text }) => (
              <div key={title} className="p-6 bg-card rounded-2xl border">
      ...
      <section className="py-10 md:py-14 bg-card">
        <div className="container-market">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl md:text-2xl font-bold text-foreground">Cerca de ti</h2>
            <Link to="/productos" className="text-sm font-medium text-primary hover:underline">
              Ver todo
            </Link>
          </div>
          ...
          <div className="hero-gradient rounded-2xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-2">
                ¿Tienes algo que vender en La Paz?
              </h2>
              <p className="text-foreground/80">
                Publica gratis y llega a miles de compradores paceños.
              </p>
            </div>
            <Link
              to="/publicar"
